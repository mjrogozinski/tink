...
function(tink_cc_library)
  ...
  if(NOT _is_headers_only_lib)
    ...
    target_include_directories(${_target_name} PUBLIC $<BUILD_INTERFACE:${TINK_INCLUDE_ALIAS_DIR}> $<BUILD_INTERFACE:${TINK_GENFILE_DIR}> $<INSTALL_INTERFACE:include> $<INSTALL_INTERFACE:include/tink>)
    ...
    target_include_directories(${_target_name} INTERFACE $<BUILD_INTERFACE:${TINK_INCLUDE_ALIAS_DIR}> $<BUILD_INTERFACE:${TINK_GENFILE_DIR}> $<INSTALL_INTERFACE:include> $<INSTALL_INTERFACE:include/tink>)
